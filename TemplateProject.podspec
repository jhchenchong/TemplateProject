...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/jhchenchong/TemplateProject"
  ...
  s.author             = { "浪漫恋星空" => "727378500@qq.com" }
  ...
  s.source       = { :git => "https://github.com/jhchenchong/TemplateProject.git", :tag => s.version.to_s }
